...
movie_data_path = api.read('dataset/movies.csv', remote = 'dataset-tracker', encoding = 'utf8')
finantial_data_path = api.read('dataset/finantials.csv', remote = 'dataset-tracker', encoding = 'utf8')
opening_data_path = api.read('dataset/opening_gross.csv', remote = 'dataset-tracker', encoding = 'utf8')
